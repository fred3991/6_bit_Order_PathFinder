...
###### Подготовильтельный блок
#list_of_files = os.listdir("NewVuchich"); # директория
#CellPath = os.listdir("NewVuchich");
...
#        ON_OFF = Cell_Truth_List[i];
#        #Network = rf.Network('dsa_almaz_s2p_file/'+str(CellValue)+'_'+str(P1dB)+'_'+str(ON_OFF)+'.S2P');
#        Network = rf.Network('NewVuchich/'+str(CellValue)+'_'+str(P1dB)+'_'+str(ON_OFF)+'.S2P');
...
#pickle.dump(BruteForce, open('PHASE_SHIFTER_BruteForce_NewVuchich.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL);

#BruteForce =  pickle.load(open('PHASE_SHIFTER_BruteForce_NewVuchich.pkl', 'rb'));
...
#for i in range(len(BruteForce)):
#    if (BruteForce[i].Max_S11_dB<Level and BruteForce[i].Max_S22_dB<Level):
#        Sorted_Brute.append(BruteForce[i])
#    else:
#        continue;
#Sorted_Brute = sorted(Sorted_Brute, key = lambda StateSystemDevice: StateSystemDevice.RMS_S21_dB_DSA);
...
#import xlsxwriter
#workbook = xlsxwriter.Workbook('Nik_Vuchich_Hello.xlsx');
...
#################################
# #### 5 битный фазовращатель, 

###### Подготовильтельный блок
#list_of_files = os.listdir("to Vuchich_Obrez"); # директория
#CellPath = os.listdir("to Vuchich_Obrez");
...
#    #######################
#    #######################
#    RMS_S21_dB_DSA = 0#Get_RMS_S21_dB_DSA(List_Of_MF_S21_dB);  # Расчет СКО по амплитуде для ЦАТТ из листа List_Of_MF_S21_dB  -- Для фитнесс функции
#    RMS_S21_deg_DSA = 0#Get_RMS_S21_deg_DSA(List_Of_MF_S21_deg); # Ррасчет СКО по градусам для ЦАТТ из листа List_Of_MF_S21_deg -- Для фитнесс функции
...
##pickle.dump(BruteForce, open('PHASE_SHIFTER_OBrez_BruteFOrce.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL);


#BruteForce =  pickle.load(open('PHASE_SHIFTER_OBrez_BruteFOrce.pkl', 'rb'));
...
#for i in range(len(BruteForce)):
#    if BruteForce[i].Max_S11_dB<-11 and BruteForce[i].Max_S22_dB<11:
#        Sorted_Brute.append(BruteForce[i])
#    else:
#        continue;

#for i in range(len(Sorted_Brute)):
#    print(Sorted_Brute[i].Max_S11_dB)
#print('sho')
