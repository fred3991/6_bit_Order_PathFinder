...
#BruteForce =  pickle.load(open('DSA_BruteForce_1.pkl', 'rb'));
...
pickle.dump(BruteForce, open('PHASE_SHIFTER_BruteForce_Temp.pkl', 'wb'), protocol=pickle.HIGHEST_PROTOCOL);


BruteForce =  pickle.load(open('PHASE_SHIFTER_BruteForce_Temp.pkl', 'rb'));
